module Data.Char.Decode.CodePage437.Graphic
  ( CodePage437Graphic(..)
  ) where
...
instance ByteEncoding CodePage437Graphic where
  decodeByte CodePage437Graphic = decodeCodePage437Graphic
  encodeByte CodePage437Graphic = encodeCodePage437Graphic



decodeCodePage437Graphic :: Word8 -> Char
decodeCodePage437Graphic c = case c of
  0x00 -> '\x0000' -- NULL
  0x01 -> '\x263a' -- WHITE SMILING FACE
  0x02 -> '\x263b' -- BLACK SMILING FACE
  0x03 -> '\x2665' -- BLACK HEART SUIT
  0x04 -> '\x2666' -- BLACK DIAMOND SUIT
  0x05 -> '\x2663' -- BLACK CLUB SUIT
  0x06 -> '\x2660' -- BLACK SPADE SUIT
  0x07 -> '\x2022' -- BULLET
  0x08 -> '\x25d8' -- INVERSE BULLET
  0x09 -> '\x25cb' -- WHITE CIRCLE
  0x0a -> '\x25d9' -- INVERSE WHITE CIRCLE
  0x0b -> '\x2642' -- MALE SIGN
  0x0c -> '\x2640' -- FEMALE SIGN
  0x0d -> '\x266a' -- EIGHTH NOTE
  0x0e -> '\x266b' -- BEAMED EIGHTH NOTES
  0x0f -> '\x263c' -- WHITE SUN WITH RAYS
  0x10 -> '\x25ba' -- BLACK RIGHT-POINTING POINTER
  0x11 -> '\x25c4' -- BLACK LEFT-POINTING POINTER
  0x12 -> '\x2195' -- UP DOWN ARROW
  0x13 -> '\x203c' -- DOUBLE EXCLAMATION MARK
  0x14 -> '\x00b6' -- PILCROW SIGN
  0x15 -> '\x00a7' -- SECTION SIGN
  0x16 -> '\x25ac' -- BLACK RECTANGLE
  0x17 -> '\x21a8' -- UP DOWN ARROW WITH BASE
  0x18 -> '\x2191' -- UPWARDS ARROW
  0x19 -> '\x2193' -- DOWNWARDS ARROW
  0x1a -> '\x2192' -- RIGHTWARDS ARROW
  0x1b -> '\x2190' -- LEFTWARDS ARROW
  0x1c -> '\x221f' -- RIGHT ANGLE
  0x1d -> '\x2194' -- LEFT RIGHT ARROW
  ...
  _ -> error $ "Word8 value '" ++ show c ++ " out of range in CodePage437.Graphic"



encodeCodePage437Graphic :: Char -> Either Char Word8
encodeCodePage437Graphic c = case c of
  '\x0000' -> Right 0x00 -- NULL
  '\x263a' -> Right 0x01 -- WHITE SMILING FACE
  '\x263b' -> Right 0x02 -- BLACK SMILING FACE
  '\x2665' -> Right 0x03 -- BLACK HEART SUIT
  '\x2666' -> Right 0x04 -- BLACK DIAMOND SUIT
  '\x2663' -> Right 0x05 -- BLACK CLUB SUIT
  '\x2660' -> Right 0x06 -- BLACK SPADE SUIT
  '\x2022' -> Right 0x07 -- BULLET
  '\x25d8' -> Right 0x08 -- INVERSE BULLET
  '\x25cb' -> Right 0x09 -- WHITE CIRCLE
  '\x25d9' -> Right 0x0a -- INVERSE WHITE CIRCLE
  '\x2642' -> Right 0x0b -- MALE SIGN
  '\x2640' -> Right 0x0c -- FEMALE SIGN
  '\x266a' -> Right 0x0d -- EIGHTH NOTE
  '\x266b' -> Right 0x0e -- BEAMED EIGHTH NOTES
  '\x263c' -> Right 0x0f -- WHITE SUN WITH RAYS
  '\x25ba' -> Right 0x10 -- BLACK RIGHT-POINTING POINTER
  '\x25c4' -> Right 0x11 -- BLACK LEFT-POINTING POINTER
  '\x2195' -> Right 0x12 -- UP-DOWN ARROW
  '\x203c' -> Right 0x13 -- DOUBLE EXCLAMATION MARK
  '\x00b6' -> Right 0x14 -- PILCROW SIGN
  '\x00a7' -> Right 0x15 -- SECTION SIGN
  '\x25ac' -> Right 0x16 -- BLACK RECTANGLE
  '\x21a8' -> Right 0x17 -- UP DOWN ARROW WITH BASE
  '\x2191' -> Right 0x18 -- UPWARDS ARROW
  '\x2193' -> Right 0x19 -- DOWNWARDS ARROW
  '\x2192' -> Right 0x1a -- RIGHTWARDS ARROW
  '\x2190' -> Right 0x1b -- LEFTWARDS ARROW
  '\x221f' -> Right 0x1c -- RIGHT ANGLE
  '\x2194' -> Right 0x1d -- LEFT RIGHT ARROW
  '\x25b2' -> Right 0x1e -- BLACK UP-POINTING TRIANGLE
  '\x25bc' -> Right 0x1f -- BLACK DOWN-POINTING TRIANGLE
